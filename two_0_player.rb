# Create a 2-Player math game where players take turns to answer simple math addition problems. A new math question is generated for each turn by picking two numbers between 1 and 20. The player whose turn it is must answer question correctly or lose a life.
...
# After End of each question output to show current score for both players
# when a player reaches zero lives, game should announce winner
...
#Nouns as Classes
#Player (state): tracks name and lives left
#Lives(Behaviour): incorrect answered, lose life from players lifetotal
#Score(Behaviour): remaining lives of both players
